...
public class DataInitializer {
    ...
    public CommandLineRunner initData(UserService userService) {
        return args -> {
            ...
            User coach2 = new User("Ugo", "Piccio", "UgoPiccio@jourrapide.com", "UgoPiccio@jourrapide.com1A", rolesCoach, false, true, false);
            userService.create(coach2);

            User coach3 = new User("Mauro", "Milani", "MauroMilani@teleworm.us", "MauroMilani@teleworm.usm1A", rolesCoach, false, true, false);
            userService.create(coach3);

            User coach4 = new User("Giacomo", "Dellucci", "GiacomoDellucci@teleworm.us", "GiacomoDellucci@teleworm.us1A", rolesCoach, false, true, false);
