...
public class DataInitializer {
    ...
    public CommandLineRunner initData(DivisionService divisionService) {
        return args -> {
            ...
            Coach coach2 = new Coach(10L, "Francesca", "Piccio", "FrancescaPiccio@jourrapide.com", 3L, physical, 12.482932, 41.89332, "03207098099", cyberSecurity);
            coachService.create(coach2);

            Coach coach3 = new Coach(11L, "Laura", "Milani", "LauraMilani@teleworm.us", 4L, psychological, 11.2555762, 43.769871, "03207098098", cloud);
            coachService.create(coach3);

            Coach coach4 = new Coach(12L, "Giulia", "Dellucci", "GiuliaDellucci@teleworm.us", 5L, economic, 9.189982, 45.464204, "03561055258", electronic);
