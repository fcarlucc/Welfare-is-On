...
export class SignUpSurveyComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.surveyForm = this.fb.group({
      ...
      // otherTitle: ['', this.validatorService?.validateTitle()],
  ...
  onSubmit(): void {
    ...
    if (this.surveyForm.valid) {
      ...
      if (sessionStorage.getItem('google_access_token') !== null) {
        ...
        console.log('entrato nel secondo')
        ...
        this.apiService.post('api/auth/sign-up',
          {
            ...
            interests: ['SPORT', 'READING']    //this.user.survey.interests
          }
        ).subscribe({
          next: (response) => {
        ...
        console.log('entrato nel terzo')
        console.error('User is undefined')
        this.navigateTo('sign-in')
      }
      // this.leaveService.canLeave = true
    } else {
      console.log('entrato nel quarto')
  ...
  canDeactivate(): boolean {
    console.log('canDeactivate chiamato');
    console.log('Stato del modulo:', this.surveyForm.valid);
